...
- 需要用户确认：学习内容编辑是否补齐为名称、状态、预计工时、截止日期、进度。
...
2. 用户确认学习内容编辑是否补齐完整基础字段。
3. 补齐学习内容完整字段编辑。
4. 根据确认结果收口删除学习内容语义。
5. 优化资料删除失败处理：失败项保留、可重试、提示清晰。
6. 用真实 txt、图片、多页 PDF 做手工验收。
7. 跑完整工程验收命令。
8. 重新生成 Tauri debug 包供最终验收。
